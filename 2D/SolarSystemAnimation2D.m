...
% Create animation using rotateShape (created in lab session 2)
% and RandomMatrix, randomStarCoordinates, drawStarryBackground,
...
f.Position = [(1920 - 1080) / 2, 0, 1000, 1000];
hold on;
